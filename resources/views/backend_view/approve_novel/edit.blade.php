                                ...
                                <form id="save">
                                    ...
                                    <br>
                                     ...
                                     <div class="text-right">
                                        <button class="btn btn-primary" type="button" onclick="save()"><i class="fas fa-share"> </i> Approve</button>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            [
                ...
                function (instance, toast) {
                  ...
                  $.ajaxSetup({
                    ...
                    $.ajax({
                        type: "POST",
                        url:'{{ route('approve_novel_update') }}',
                        data: formdata ? formdata : form.serialize()+'&'+id_old,
                        processData: false,
                        contentType: false,
                      success:function(data){
                        if (data.status == 'sukses') {
                            ...
                            location.href = '{{ route('approve_novel') }}'
