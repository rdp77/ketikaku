        ...
        @if (Auth::user()->m_isactive == 'N')
            <div class="bg-light no-card-border">
                <div class="alert alert-warning">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true">×</span> </button>
                        <h3 class="text-warning"><i class="fa fa-info-circle"></i> Peringatan</h3> Verifikasi ke email  {{ Auth::user()->m_email }}   diperlukan agar mendapatkan akses untuk menulis. email verifikasi akan membutuhkan beberapa waktu. <a href="#" onclick="verify()" class="btn btn-primary btn-sm"> <b><strong> Verifikasi </strong></b></a>
                        <br>
