                    ...
                    <tbody>
                        <tr>
                            <td>
                                ...
                                <center>
                                    <a href="{{ url('/verify/'.$token.'/'.$code) }}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-size: 15px; color: #fff; background: #4fc3f7; border-radius: 60px; text-decoration:none;">Verifikasi</a>
                                </center>
